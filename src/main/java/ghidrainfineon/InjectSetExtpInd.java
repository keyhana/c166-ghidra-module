...
public class InjectSetExtpInd extends InjectPayloadCallother {
	private SleighLanguage language;
	private long uniqueBase;
	
	public InjectSetExtpInd(String name, SleighLanguage language, long uniqueBase) {
		super(name);
	...
	public PcodeOp[] getPcode(Program program, InjectContext con) throws MemoryAccessException {
		...
		emitter.emitAssignRegisterToRegister(con.inputlist.get(0), "Extp");
